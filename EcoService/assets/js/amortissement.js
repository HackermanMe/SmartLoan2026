...
function genererTableauProgressif(lignes, data) {
    ...
    if (!lignes || !Array.isArray(lignes)) {
        ...
        afficherErreur("Impossible d'afficher le tableau : aucune ligne d'amortissement retournée.");
        return;
    }
    ...
    // Si tableau vide
    if (lignes.length === 0) {
        afficherErreur("Aucune échéance trouvée pour ce calcul.");
        return;
    }
...
//    if (!lignes || !Array.isArray(lignes)) {
//        afficherErreur("Erreur : le serveur n'a pas retourné les lignes du tableau d'amortissement.");
//        return;
//    }
