...
namespace EcoService.Controllers.Content
{
    public class ATMController : Controller
    {
        public ActionResult ExtraireExcel()
        {
            ...
            OracleDataReader DbReader = Lr.ATMExtractions(startDate, endDate);

            int ver = 1;
            String Rapport = "ATM-Extractions";
        ...
        public void ExtraireCsv()
        {
            ...
            OracleDataReader DbReader = Lr.MvtAffaireCM(startDate, endDate);
