...
{
    public class AdresseClientPphysiqueController : Controller
    {
        ...
        public ActionResult ExtraireExcel()
        {
           ...
           String thefile = WebConfigurationManager.AppSettings["ExportPath"].ToString() + file.Substring(12, file.Length - 12);
            ...
            OracleDataReader DbReader = Lr.AdresseClientPp(listecompte);

            int ver = 1;
            String Rapport = "ADRESSE-CLIENT-LISTE";
            ...
            String folderPath2 = WebConfigurationManager.AppSettings["ExportPath"].ToString();

            string path2 = folderPath2 + filename2 + ".xlsx";
            ...
            return File(path2, "application/xlsx", Server.UrlEncode(filename2 + ".xlsx"));
        }
